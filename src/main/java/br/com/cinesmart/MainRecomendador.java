...
public class MainRecomendador {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("   - Já assistiu: Blade Runner 2049 (nota 5)");
        ...
        perfil.marcarComoAssistido("film_blade_runner");
        perfil.adicionarNota("film_blade_runner", 5);
        ...
        if (!recomendacoes.isEmpty()) {
            ...
            System.out.println("⏱️  Duração: " + filme.getDuracao() + " minutos");
